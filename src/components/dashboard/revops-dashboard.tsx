...
import { formatCurrency, formatRelativeDate, getStatusColor, getPriorityColor, cn } from '@/lib/utils'
import {
  getDemoMetrics, getDemoWorkload, getDemoRecentActivities,
  demoTransitions, demoAccounts, demoTeamMembers
} from '@/lib/demo-data'
import { NumberTicker } from '@/components/ui/number-ticker'
import Link from 'next/link'

const RevOpsCharts = dynamic(
  () => import('./revops-charts').then(m => ({ default: m.RevOpsCharts })),
  { ssr: false, loading: () => <div className="h-[340px] rounded-xl bg-muted/30 animate-pulse" /> }
)
